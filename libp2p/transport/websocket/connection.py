...
class P2PWebSocketConnection(ReadWriteCloser):
    ...
    def __init__(self, ws_connection: Any, ws_context: Optional[Any] = None) -> None:
    ...
    def get_remote_address(self) -> Optional[tuple[str, int]]:
        ...
        try:
            ...
            if hasattr(self._ws_connection, '_stream') and hasattr(self._ws_connection._stream, 'socket'):
